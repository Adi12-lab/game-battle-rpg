...
public class Knight extends Hero implements Character, Armor {
    private final String senjata = "Pedang";
    private final int attackPoint = 20;
    ...
    public Knight(String name, int healthPoint, int magicPoint) {
        super(name, "Knight", healthPoint, magicPoint);
    }
