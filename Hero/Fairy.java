...
public class Fairy extends Hero implements Character, Armor {
    private final String senjata = "Magic Wand";
    private final int attackPoint = 12;
    ...
    public Fairy(String name, int healthPoint, int magicPoint) {
        super(name, "Fairy", healthPoint, magicPoint);
    }
